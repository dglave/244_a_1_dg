...
Now I have a summary table, across all years, of Adult and Subadult **Rana muscosa**. In the df, I've made lake_id a factor, added the word "Lake" before each ID number, and reordered the lakes. In their new order, the 5 lakes are listed from highest to lowest counts of 8*Rana muscosa*8
